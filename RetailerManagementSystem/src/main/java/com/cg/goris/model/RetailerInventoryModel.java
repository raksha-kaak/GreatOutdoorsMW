...
//		return "RetailerInventoryModel [retailerId=" + retailerId + ", productCategory=" + productCategory
//				+ ", productId=" + productId + ", productName=" + productName + ", productQuantity=" + productQuantity
//				+ ", totalAmount=" + totalAmount + ", productReceiveTimeStamp=" + productReceiveTimeStamp + "]";
//	}
